  ...
  return html`
    <li>
      <button
        ...
        class="group w-full flex items-center gap-2 px-3 py-1.5 text-xs font-semibold
      ...
      >
        ...
        <span class="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
          <button type="button" onClick=${handleCreateGroup} title="New subgroup"
            class="p-0.5 rounded dark:text-tn-muted hover:dark:text-tn-blue transition-colors">
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
            </svg>
          </button>
          <button type="button" onClick=${handleRename} title="Rename group"
            class="p-0.5 rounded dark:text-tn-muted hover:dark:text-tn-blue transition-colors">
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button type="button" onClick=${handleDeleteGroup} title="Delete group"
            class="p-0.5 rounded dark:text-tn-muted hover:dark:text-tn-red transition-colors">
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
