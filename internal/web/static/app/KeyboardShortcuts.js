...
const BINDINGS = [
  ...
  { keys: ['r'],               label: 'Edit / rename focused session' },
  { keys: ['Shift', 'A'],      label: 'Archive / unarchive focused session' },
  { keys: ['Ctrl', 'A'],       label: 'Toggle show archived sessions' },
  { keys: ['Shift', 'M'],      label: 'Move focused session to a group' },
