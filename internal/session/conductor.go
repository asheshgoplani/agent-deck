...
type ConductorSettings struct {
	...
	// 'conductor setup' per conductor to regenerate + reload the daemon (a
	// 'conductor migrate-dir' helper is planned to automate this). The bridge
	// daemon similarly freezes AGENT_DECK_CONDUCTOR_DIR at install time.
	Dir string `toml:"dir"`
}
