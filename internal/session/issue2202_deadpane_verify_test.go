...
func TestIssue2202_VerifySpawnedRemainOnExitDiesFast(t *testing.T) {
	...
	inst.startFastDeathWatcher(cmd, inst.tmuxSession, inst.ID, inst.Tool, sessionLog)
...
func TestIssue2202_VerifySpawnedRemainOnExitHealthy(t *testing.T) {
	...
	inst.startFastDeathWatcher("sleep 60", inst.tmuxSession, inst.ID, inst.Tool, sessionLog)
