...
- [recall skill](recall/SKILL.md) - Durable session hints and tags, and the cross-harness transcript index (search/show/open, the TUI G key); context handoff and MCP in phase 4
