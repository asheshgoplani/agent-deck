...
This endpoint allows you to verify the availability of Fleet API without requiring user authentication.  
  
 **Note:** This endpoint is subject to a rate limit, allowing a maximum of 1 request every 5 minutes.
